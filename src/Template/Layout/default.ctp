...
<html>
    <head>
        ...
        <?php
            ...
            echo $this->Html->script(["jquery2.min","jquery1.fakecrop", "bootstrap.min", "jquery.rateyo.min","bootstrap-waitingfor.min", "owlcarousel/owl.carousel", "slick/slick.min"]);
        ?>
    </head>
    <body>
        <div class="container-fluid" id="full-width" >
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="navbar-form navbar-right">
                                ...
                                <div class="input-group stylish-input-group">
                                    ...
                                    <?php echo $this->Form->create($index,array('url' => '/packages/search')); ?>
            ...
            <div class="row text-center" id="banner_gallery" >

                <video id="video" width="" height="300" loop="loop" autoplay="" muted>
                    <source src="<?php echo BASE_URL?>video/video.mp4" type="video/mp4" alt="seeingo video" />
                    Your browser does not support the video tag.
                </video>
                <div id="overlay"></div>
                <div id="content" class="hideshow_text">
                    
                    <div class="big_break"></div>
                    <center><?php echo $this->Html->link('help me plan my trip',['controller'=>'contacts','action'=>'queryform'],['class'=>'font-white button text-uppercase head_subtext hideshow new_break']);?></center>  
                    <div class="small_break"></div>
                    <?php echo $this->Html->image("icons/sound_unmuted.png", array("height"=>"40", "id"=>"toggler", "class" => "hideshow"));?>

                    <div class="small_break"></div>
                    <div class="head_bigtext text-uppercase hideshow">perfect your dream vacation</div>
                    <div class="head_minitext text-uppercase hideshow">travel to the four corners of the world, without going around in circles.</div>
                </div>
...
<script>
   ...
   var isMuted = true; 
    $('#toggler').click(function(e) {
        ...
        if(isMuted == true){
            $("#toggler").attr('src',"img/icons/sound_unmuted.png");
        }else{
            $("#toggler").attr('src',"img/icons/sound_muted.png");
        }
    });
